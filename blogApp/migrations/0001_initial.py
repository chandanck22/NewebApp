    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author', to='blogApp.profile')),
                ('tags', models.ManyToManyField(blank=True, related_name='tags', to='blogApp.tag')),
            ],
            options={
                'ordering': ('-publish',),
            },
